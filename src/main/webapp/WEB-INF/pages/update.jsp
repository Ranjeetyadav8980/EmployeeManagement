...
<head>
<meta charset="UTF-8">
<title>Update Room - Reax Hotel Management System</title>
...
<div class="overlay">
    ...
    <div class="card">
        <h2>Update Room Panel</h2>

        <frm:form action="emp_edit" method="post" modelAttribute="room">

            <!-- IMPORTANT: Hidden ID -->
            <frm:hidden path="roomId"/>

            <!-- Room Number (readonly) -->
            <frm:input path="roomNumber" readonly="true"/>
